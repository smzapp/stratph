  ...
  return (
    <div>
      <PageHeader
        ...
        description="Reduce hiring risk with paid auditions, or search verified activity to reverse-hire."
        actions={
          <>
      ...
      <div className="mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <StatCard label="Auditions upgraded" value={upgraded} tone="emerald" hint="to part-time/contract/full-time" />
