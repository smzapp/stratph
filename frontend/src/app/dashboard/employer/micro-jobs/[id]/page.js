...
export default function EmployerMicroJobDetail() {
  ...
  const [offerType, setOfferType] = useState(UPGRADE_TYPES[0]);
  ...
  function openUpgrade(jobseekerId) {
